;--------------------------------------------------------------------------------------
; Version with listbox and parameter for input file.
;--------------------------------------------------------------------------------------
; to read:
; IniRead, valueOfX, %A_ScriptFullPath%, settings, X
; to write:
; IniWrite, 540, %A_ScriptFullPath%, settings, Y
/*
[settings]
winX=486
winY=0
...
; DONE: show the actual statement number.
; DONE: replace listview with listbox in order to compress the lines.
;--------------------------------------------------------------------------------------
...
showGui() {
    ...
    IniRead, valueOfX, %A_ScriptFullPath%, settings, winX
    IniRead, valueOfY, %A_ScriptFullPath%, settings, winY
    IniRead, valueOfWidth, %A_ScriptFullPath%, settings, winWidth
    IniRead, valueOfHeight, %A_ScriptFullPath%, settings, winHeight
...
initialize() {
    ...
    IniRead, valueOfHeight, %A_ScriptFullPath%, settings, winHeight
    IniRead, valueOfTreeviewWidth, %A_ScriptFullPath%, settings, treeviewWidth
...
GuiClose:  ; Exit the script when the user closes the TreeView's GUI window.
    ...
    IniWrite, %winX%, %A_ScriptFullPath%, settings, winX
    IniWrite, %winY%, %A_ScriptFullPath%, settings, winY
    IniWrite, %winWidth%, %A_ScriptFullPath%, settings, winWidth
    IniWrite, %winHeight%, %A_ScriptFullPath%, settings, winHeight
    IniWrite, %treeviewWidth%, %A_ScriptFullPath%, settings, TreeViewWidth
    ExitApp
