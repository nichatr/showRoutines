...
Prism.languages.cobol = {
  ...
  // sections
  important: /\s(?:configuration|data|declaratives|division|environment|file-control|function|function-id|i-o|i-o-control|identification|input-output|input|linkage|local-storage|output|procedure|program-id|program|screen|section|special-names|working-storage|exec|end-exec)(?![\w-])/i,
  keyword: [
    // main keywords
